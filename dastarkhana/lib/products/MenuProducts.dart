...
class _MenuProductsState extends State<MenuProducts> {
                ...
                Row(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      child: const Text("Қолдану",style: TextStyle(
  ...
  void showPromoMessage() {
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text("Бұл уақытта кепілдікпен тағам жоқ."),
      ),
    );
  }
