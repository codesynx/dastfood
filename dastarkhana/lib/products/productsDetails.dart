...
class _ProductsdetailsState extends State<Productsdetails> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          product['name'] ?? 'Тағам туралы толық ақпарат',
          style: TextStyle(fontSize: 20, fontFamily: 'SF-Pro-Text-Bold', color: Colors.black),
        ),
      ),
      body: ListView(
        children: [
          Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  product['description'] ?? 'Сипаттама қолжетімсіз',
                  style: TextStyle(
                    fontFamily: 'SF-Pro-Text-Regular',
                    fontSize: 17,
                    color: Colors.grey,
                  ...
                  child: Column(
                    children: [
                      Row(
                        ...
                        children: [
                          Text(
                            '${totalPrice.toStringAsFixed(3)} тг',
                            style: TextStyle(
                              fontSize: 20,
                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                Text(
                                  '$quantity',
                                  style: TextStyle(color: Colors.white, fontSize: 16, fontFamily: "SF-Pro-Text-Bold"),
                                ),
                                IconButton(
                      ...
                      ElevatedButton(
                        onPressed: () {
                          ...
                          _showSnackBar('Тағам себетке қосылды!', Colors.indigo);
                        },
  ...
  Widget _buildIconText(String assetPath, String text) {
    return Row(
      children: [
        ...
        Text(
          text,
          style: TextStyle(fontFamily: "SF-Pro-Text-Bold"),
        ),
      ],
    );
  }
