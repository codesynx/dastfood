...
class _GetHomeState extends State<GetHome> {
  ...
  Future<List<dynamic>> getCategoriesData() async {
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception('Категорияларды жүктеу мүмкін болмады');
    }
  }
  ...
  Future<List<dynamic>> getProductData() async {
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception('Тағамдарды жүктеу мүмкін болмады');
    }
  }
  ...
  Future<void> loadAllData() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception('Пайдаланушы деректерін жүктеу мүмкін болмады');
      }
    } catch (e) {
      if (mounted) {
        setState(() {
      ...
      debugPrint('Деректерді жүктеу кезінде қате шықты: $e');
    }
  }
