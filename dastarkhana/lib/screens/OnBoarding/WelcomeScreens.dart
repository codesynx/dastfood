                  ...
                  child: Column(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Center(
                          child: Text(
                            "Жаңа деңгейдегі дәм мен сапаны ашыңыз. Dastarkhana — әрқашан сіздің таңдауыңыз!",
                            style: TextStyle(color: Colors.white, fontSize: 14, fontFamily: "SF-Pro-Text-Regular"),
                            textAlign: TextAlign.center,
                          ),
                        ),
                      ),
