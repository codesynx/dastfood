import 'package:Dastarkhana/services/UserService/signup_service.dart';
import 'package:Dastarkhana/widgets/AuthFormWidget/SocialMediaIconsWidget.dart';
          ...
          child: Column(
            children: [
              Center(
                child: Column(
                  children: [
                    HeaderWidget("Кіру", text: 'Жаңа аккаунт құру',),
                  ],
                ),
              ),
              SizedBox(height: 20),
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      SizedBox(height: 20),
                      TextDividerWidget(text: "Немесе келесімен жалғастырыңыз"),
                      SizedBox(height: 20),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          InkWell(
                            ...
                            child: Text(
                              " Кіру",
                              style: TextStyle(color: disabledButtonColor, fontFamily: "SF-Pro-Text-Semibold"),
                              textAlign: TextAlign.center,
                            ),
  ...
  Widget _buildTextFormField({
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        hintText: hintText,
        hintStyle: TextStyle(fontSize: 13, fontFamily: 'SF-Pro-Text-Regular'),
