    ...
    return Container(
      ...
      child: SafeArea(
        child: Column(
          ...
          children: [
            SummaryRowWidget(label: "Аралық сома", amount: subtotal),
            SizedBox(height: 8),
            SummaryRowWidget(label: "Жеткізу ақысы", amount: deliveryFee),
            Padding(
              padding: EdgeInsets.symmetric(vertical: 12),
              child: Divider(color: Colors.grey[300]),
            ),
            SummaryRowWidget(label: "Жалпы сома", amount: total, isTotal: true),
            SizedBox(height: 16),
            ElevatedButton(
