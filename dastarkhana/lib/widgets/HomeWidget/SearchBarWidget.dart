    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (data is List) {
          ...
          print('Жауаптың форматы дұрыс емес');
        }
      } else {
        print('Деректерді жүктеу мүмкін болмады');
      }
    } catch (error) {
      print('Деректерді алу кезінде қате шықты: $error');
    }
      ...
      children: [
        TextField(
          ...
          decoration: InputDecoration(
            hintText: 'Қандай тағам жегіңіз келеді?',
                ...
                itemBuilder: (context, index) {
                  ...
                  return InkWell( onTap: () {
                    Get.to(() => Productsdetails(
                      product: result,
                      categoryName: result['category']['name'] ?? 'Белгісіз', quantity: null,
                    ));
                  }, child:ListTile(
